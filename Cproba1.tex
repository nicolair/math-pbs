...
\begin{figure}[h]
  \centering
  \includegraphics[width=6cm]{./Cproba1_fig1.pdf}
  % Cproba1_fig1.pdf: 650x188 pixel, 72dpi, 22.93x6.63 cm, bb=0 0 650 188
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=7cm]{./Cproba1_fig2.pdf}
...
\begin{figure}[h!]
  \begin{minipage}{7cm}
    \centering
    \includegraphics[width=6cm]{./Cproba1_fig3.pdf}
    \caption{issues épreuve avec BC}
    \label{fig:Cproba1_fig3}
  \end{minipage}
  \begin{minipage}{7cm}
    \centering
    \includegraphics[width=6cm]{./Cproba1_fig4.pdf}
