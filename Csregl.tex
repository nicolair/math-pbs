...
% remplacer inclure par include
%\begin{center}
%\incluregraphics[width=4.5cm]{sreglC1.eps}
%\hfill
%\incluregraphics[width=4.5cm]{sreglC2.eps}
%\incluregraphics[width=4.5cm]{sreglC3.eps}
%\hfill
%\incluregraphics[width=4.5cm]{sreglC4.eps}
%\end{center}
\end{enumerate}
